...
export function createFallbackCometRush(parent: HTMLElement, bridge: TossBridge) {
  ...
  function menu() {
    ...
    round(18, 54, 354, 708, 32);
    ctx.fill();
    const grad = ctx.createLinearGradient(24, 70, 366, 760);
    grad.addColorStop(0, 'rgba(10,32,52,.96)');
    grad.addColorStop(.55, 'rgba(6,17,31,.96)');
    grad.addColorStop(1, 'rgba(2,7,17,.98)');
    ctx.fillStyle = grad;
    round(24, 70, 342, 690, 30);
    ctx.fill();
    ctx.strokeStyle = 'rgba(0,194,255,.34)';
    ctx.stroke();
    ctx.strokeStyle = 'rgba(255,200,87,.13)';
    round(36, 88, 318, 652, 24);
    ctx.stroke();
    ctx.fillStyle = 'rgba(0,194,255,.08)';
    ctx.beginPath();
    ctx.ellipse(72, 178, 118, 78, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = 'rgba(255,200,87,.08)';
    ctx.beginPath();
    ctx.ellipse(314, 318, 96, 128, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#86e8ff';
    ctx.font = '900 11px sans-serif';
    ctx.fillText('APPS IN TOSS · PREMIUM PAYDAY RUN', W / 2, 24);
    ...
    ctx.fillStyle = 'rgba(255,79,100,.14)';
    round(W / 2 - 141, 46, 282, 36, 18);
    ctx.fill();
    ctx.strokeStyle = 'rgba(255,79,100,.42)';
    ctx.stroke();
    ctx.fillStyle = '#fff4d8';
    ctx.font = '900 13px sans-serif';
    ctx.fillText('LIVE RISK · 월급 공격 감지', W / 2, 68);
    ctx.shadowBlur = 24;
    ctx.shadowColor = '#00c2ff';
    ctx.fillStyle = '#f8fbff';
    ctx.font = '900 48px sans-serif';
    ctx.fillText('월급', W / 2, 276);
    ctx.fillText('지키기', W / 2, 328);
    ctx.shadowBlur = 0;
    ctx.fillStyle = '#b8d9e7';
    ctx.font = '14px sans-serif';
    ctx.fillText('60초, 잔고를 잃지 않는 가장 짜릿한 방법', W / 2, 358);
    ctx.fillStyle = 'rgba(255,200,87,.10)';
    round(W / 2 - 134, 388, 268, 36, 18);
    ctx.fill();
    ctx.strokeStyle = 'rgba(255,200,87,.38)';
    ctx.stroke();
    ctx.fillStyle = '#ffc857';
    ctx.font = '900 11px sans-serif';
    ctx.fillText('월급 세이프티 스코어', W / 2 - 38, 400);
    ctx.fillStyle = '#f8fbff';
    ctx.font = '900 13px sans-serif';
    ctx.fillText(`${best.toLocaleString('ko-KR')}원 보호`, W / 2 + 62, 414);
    ctx.fillStyle = '#ffc857';
    ctx.font = '900 16px sans-serif';
    ctx.fillText(`최고 잔고 ${best.toLocaleString('ko-KR')}`, W / 2, 452);
    ctx.font = '900 12px sans-serif';
