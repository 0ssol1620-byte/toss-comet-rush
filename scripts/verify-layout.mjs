...
assert(source.includes("BUILD_VERSION = 'v14c-single-combo'"), 'source build stamp is not v14c-single-combo');
...
for (const target of exportsToCheck) {
  ...
  assert(html.includes('v14c-single-combo'), `export ${target} does not contain v14c-single-combo stamp`);
